# عکس‌ها را اینجا بگذار (نام دقیق مهم است)
...
- `assets/images/cookies.png` → کوکی کشمشی
- `assets/images/birthday.png` → کیک تولد

اگر فایلی نباشد اپ با آیکون ایموجی کار می‌کند و کرش نمی‌کند.
برای آیکون لانچر نهایی از `flutter_launcher_icons` یا Android Studio > Image Asset استفاده کن.
